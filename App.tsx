...
const sampleProjects: Project[] = [
  ...
  { id: '2', title: 'AI Prompt Architect', description: 'A powerful AI prompt engineering tool built with React, TypeScript, and Google\'s Gemini AI. Features include multi-language support, real-time chat, image analysis, code execution, and voice input capabilities.', imageUrl: '/images/ai-prompt-project.jpg', technologies: ['React', 'TypeScript', 'Google Gemini AI', 'Tailwind CSS', 'OneCompiler API'], githubUrl: 'https://github.com/KOSALSENSOK096/AI-Prompt-Architect', liveDemoUrl: 'https://ai-prompt-architect.vercel.app/#/premium' },
